...
prompt_get_user_information = """Your task is to retrieve the users running goal from 
            the provided information,a goal is for example "Stockholm Marathon", "10km in 50 minutes" or "improve health". If the user has a goal you should return it as a JSON object with the key "goal" and the value
            as the goal {"goal": goal}, else you should return "no goal" as value"""
